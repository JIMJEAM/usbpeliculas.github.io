...
class Menu extends HTMLElement {
 ...
 <ul id="video_navigation" style="list-style-type: none; display: grid; grid-template-columns: repeat(3 , 1fr);">
    ...
    <li class="cursor-pointer"> <img src="https://detodopeliculas.nu/wp-content/uploads/2024/07/deadpool_and_wolverine-poster-nuevo.jpg" alt="Deadpool and Wolverine (2024)" class="img_video_nav img-thumbnail w-50" onclick="videoUrl('https://stream-4491-212-99.cdnpvd.co/keohohecbmikkfn2mdr7qn2knu4h5tsaz25qj635u6dhudkxslouwi76ny/v.mp4')"> </li> 
